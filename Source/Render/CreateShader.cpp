...
void CheckShaderCompileStatus(GLuint shader, const char* name) {
    GLint success;
...
GLuint ShaderCreate(const char* vertexShaderSource, const char* fragmentShaderSource ) { //const char* geometryShaderSource
...
GLuint ShaderCreate(const char* computeShaderSource) { //const char* geometryShaderSource
...
void* loadTextureRGBA(const std::string& path) {
    int w,h,channels;
