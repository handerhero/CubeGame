...
set(TOOLCHAIN_PATH "/opt/llvm-mingw")
# ===========================================

# Указываем конкретные компиляторы из пакета
set(CMAKE_C_COMPILER "/opt/llvm-mingw/llvm-mingw-ucrt/bin/x86_64-w64-mingw32-clang")
set(CMAKE_CXX_COMPILER "/opt/llvm-mingw/llvm-mingw-ucrt/bin/x86_64-w64-mingw32-clang++")
set(CMAKE_RC_COMPILER "/opt/llvm-mingw/llvm-mingw-ucrt/bin/x86_64-w64-mingw32-windres")
